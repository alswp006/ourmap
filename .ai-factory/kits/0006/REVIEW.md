당신은 패킷 0006 ("PRD QA docs + privacy guardrails doc + dev stopwatch helper")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: docs/prd-goals-qa.md
docs/privacy-guardrails.md
src/lib/perf/stopwatch.ts
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0006 — PRD QA docs + privacy guardrails doc + dev stopwatch helper
════════════════════════════════════════════════
