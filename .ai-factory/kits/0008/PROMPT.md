## Task: Places API module (list/detail/create/update/delete)
Add Places API wrappers for all CRUD endpoints plus paginated list. Functions must follow SPEC contracts, correctly handle 204 delete responses, and accept tripId filtering for list. Keep behavior explicit so screens can show retry/401/404 UI.
