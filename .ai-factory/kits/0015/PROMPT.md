## Task: Screen: Photo Permission Help
Add a simple help screen explaining how to grant photo library permissions on iOS/Android and providing a CTA back to Place Create. This screen is used when photo picking is blocked so users can recover without guessing system settings.
