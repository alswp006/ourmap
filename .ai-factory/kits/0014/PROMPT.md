## Task: Screen: Place Map tab (pins + summary + refresh + 401 handling)
Implement the Places Map tab that fetches places (pageSize=200) and renders pins on a map. Selecting a pin shows a bottom summary card with name/address and a CTA to open Place Detail. Includes pull-to-refresh equivalent and 401 redirect.
