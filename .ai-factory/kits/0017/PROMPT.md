## Task: Screen: Place Detail (view + inline edit toggle + delete)
Implement Place Detail screen fetching /api/places/:id and displaying photos, rating, visitedAt, address and review. Provide an 'Edit' toggle to patch editable fields and a 'Delete place' action. Handle 401 redirect and 404 not-found state with retry/back CTA.
