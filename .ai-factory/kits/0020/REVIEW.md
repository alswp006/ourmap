당신은 패킷 0020 ("Final wiring + polish (routes, tab labels, cross-links)")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0020.test.ts
...
- app/(tabs)/_layout.tsx
- app/(tabs)/index.tsx
- src/__tests__/packet-0020.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: app/(tabs)/_layout.tsx
app/(tabs)/index.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0020 — Final wiring + polish (routes, tab labels, cross-links)
════════════════════════════════════════════════
