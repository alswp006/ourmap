당신은 패킷 0012 ("Shared UI components: Banner + Skeleton + RemoteImage wrapper")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/components/ui/Banner.tsx
src/components/ui/Skeleton.tsx
src/components/ui/RemoteImage.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0012 — Shared UI components: Banner + Skeleton + RemoteImage wrapper
════════════════════════════════════════════════
