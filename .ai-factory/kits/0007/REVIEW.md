당신은 패킷 0007 ("API error utilities (network vs server) + status extractor")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/lib/api/errors.ts
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0007 — API error utilities (network vs server) + status extractor
════════════════════════════════════════════════
