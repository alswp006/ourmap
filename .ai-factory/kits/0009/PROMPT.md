## Task: Trips API module (list/create/get/update/delete)
Implement Trips API wrappers with pagination and CRUD. Ensure date fields remain strings as specified and delete handles 204 correctly. These wrappers will be used by Trip List and Trip Detail screens for create/edit flows and refetching.
