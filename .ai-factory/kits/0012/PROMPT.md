## Task: Shared UI components: Banner + Skeleton + RemoteImage wrapper
Add small reusable UI pieces used across list/detail/create screens: a Banner for network/server errors with retry CTA, a Skeleton block for loading placeholders, and a RemoteImage wrapper that shows a loading placeholder until the image is fully loaded.
...
src/components/ui/Banner.tsx, src/components/ui/Skeleton.tsx, src/components/ui/RemoteImage.tsx
